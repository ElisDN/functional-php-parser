    ...
    return function ($url) use ($squashProfiles, $batchGetTopicPagesProfiles, $getTopicPages, $getForumPageTopics, $getForumPages, $chunkSize) {
        return
            reduce($squashProfiles,
                reduce('array_merge',
                    array_map($batchGetTopicPagesProfiles,
                        array_chunk(
                            reduce('array_merge',
...
$parse = createParseForumProfiles('squashProfiles', $batchGetTopicPagesProfiles, $getTopicPages, $getForumPageTopics, $getForumPages, 10);
